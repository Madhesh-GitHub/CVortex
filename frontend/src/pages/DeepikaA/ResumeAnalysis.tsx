    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-100">
      ...
      <nav className="bg-white shadow-md px-6 py-4">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-700">ATS Resume Checker</h1>
        ...
        {menuOpen && (
          <ul className="md:hidden mt-4 flex flex-col gap-3 text-gray-700 font-medium">
            <li className="hover:text-blue-600 cursor-pointer" onClick={() => setMenuOpen(false)}>Home</li>
            <li className="hover:text-blue-600 cursor-pointer" onClick={() => setMenuOpen(false)}>Login</li>
            <li className="hover:text-blue-600 cursor-pointer" onClick={() => setMenuOpen(false)}>Sign Up</li>
          </ul>
        )}
      </nav>
